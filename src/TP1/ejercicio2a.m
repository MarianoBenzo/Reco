...
%Genero las densidades de las multivariadas con mu=a1..a6 y la misma matriz
%de covarianza isotropica diagonal
sigma = [400 0;0 400];
...
% COMPARANDO LOS RESULTADOS DE LAS 6 GAUSSIANAS CLASIFICO.
        ...
        F_A=mvnpdf([i j],mu(1,:),sigma);
        F_B=mvnpdf([i j],mu(2,:),sigma);
        F_C=mvnpdf([i j],mu(3,:),sigma);
        F_D=mvnpdf([i j],mu(4,:),sigma);
        F_E=mvnpdf([i j],mu(5,:),sigma);
        F_F=mvnpdf([i j],mu(6,:),sigma);
